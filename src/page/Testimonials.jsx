...
function Testimonials() {
  ...
  const cardBg = 'bg-[#0D1117]';
  const textClass = 'text-white';
  return (
    <section className="bg-gray-900 text-white" id="testimonials">
      <div className="container mx-auto max-w-7xl px-2 sm:px-4 md:px-8 py-6 md:py-8">
        ...
        >
          {testimonials.map((t, index) => (
            <SwiperSlide key={index}>
              <div className={`rounded-xl shadow-md min-h-80 sm:min-h-90 flex flex-col justify-between ${cardBg} p-5`}>
